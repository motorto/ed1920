...
public class BTree<T> {   
  ...
  private boolean strict(BTNode<T> n){
    if (n == null)
      ...
      return false;
    else return strict(n.getRight()) && strict(n.getLeft());
  }
  ...
  private T path(BTNode<T> n , String s , int i){
    if (i == s.length() ) return n.getValue();
    else if (s.charAt(i) == 'E' ) return path(n.getLeft(),s,++i);
    else if (s.charAt(i) == 'D' ) return path(n.getRight(),s,++i);
    return null;
  }
